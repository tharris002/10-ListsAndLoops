...
#   of items.
#
#   For this _TODO_, simply create a list called ingredients that will have a
#   list of strings that represent different ingredients that you might have in
#   a recipe. Choose whichever ingredients you like, but make sure you have at
#   least 4 ingredients in your list.
#
#   You saw two different ways to create a list in the reading. Make sure you
#   use the one involving square brackets [].
#
...
#   sure you do NOT create a new list, but actually modify the original.
#
#   Once you have done this, then change the above _TODO_ to DONE.
###############################################################################
...
#   have done this, print the list. Make sure you do NOT create a new list, but
#   actually modify the original.
#
#   Once you have done this, then change the above _TODO_ to DONE.
###############################################################################
...
#   create a new list, but actually modify the original.
#
#   NOTE: Your solution should work for any list of any length. DO NOT use
...
#   a new list, but actually modify the original.
#
#   NOTE: Your solution should work for any list of any length. DO NOT use
